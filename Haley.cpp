...
Haley::Haley(int playerNumber) : AI(playerNumber)
{

}

//tracks all player moves 
void Haley::onOtherPlayerMove(int playerNumber, Card justPlayed, Color choosenCardColor) {
...
void Haley::onOtherPlayerDraw(int playerNumber) {
...
Color Haley::findMostCommonColor(vector<Card> cardsInHand) {
...
Color Haley::countCardsOfEachColor(vector<Card> cardsInHand) {
...
int Haley::makeMove(Card justPlayed, Color choosenCardColor, bool justDrew, vector<int> scores, vector<int> cardAmountsByPlayer, vector<Card> cardsInHand, int direction) {
	int toReturn = -1; 
