...
//Haley6 is slightly better than Haley5
//Haley5 will only play special cards if the colors match but 
//Haley6 can play a special card as long as the number matches (draw2, skip, reverse)
//1 point faster as of 12/7 2:17 pm 

Haley6::Haley6(int playerNumber) : AI(playerNumber) {

}

//tracks all player moves --> justPlayed is the card that the player is playing 
void Haley6::onOtherPlayerMove(int playerNumber, Card justPlayed, Color choosenCardColor) {
...
void Haley6::onOtherPlayerDraw(int playerNumber) {
...
vector<int> Haley6::countCardsOfEachColor(vector<Card>cardsInHand) {
...
Color Haley6::findMostCommonColor(Card justPlayed, Color chosenColor, vector<Card> cardsInHand) {
...
Color Haley6::findLastCardOfAColor(Card justPlayed, Color chosenColor, vector<Card> cardsInHand) {
...
int Haley6::findFinalCardIndex(vector<Card>cardsInHand, int indexInPlayableCards, Card justPlayed, Color chosenCardColor) {
...
bool Haley6::hasColorChanged(Card justPlayed, vector<Card>cardsInHand) {
	/*Color previousColor;
	Color currentColor = justPlayed.getColor(); 
...
int Haley6::makeMove(Card justPlayed, Color choosenCardColor, bool justDrew, vector<int> scores, vector<int> cardAmountsByPlayer, vector<Card> cardsInHand, int direction) {
